...
<article id="forms">
    ...
    <section>
        <doc-item-title>Prefilling Text Input</doc-item-title>
        <doc-item-demo>
            <div class="row">
    ...
    <section>
        <doc-item-title>Icon Prefixes</doc-item-title>
        <doc-item-demo>
            <div class="row">
    ...
    <section>
        <doc-item-title>Textarea</doc-item-title>
        <doc-item-demo>
        <div class="row">
    ...
    <section>
        <doc-item-title>Radio</doc-item-title>
        <doc-item-demo>
            <p>
...
<script type="babel">
    ...
    import codes from '../codes/Forms.js';
    export default {
